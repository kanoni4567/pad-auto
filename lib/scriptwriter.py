...
script_path = "C:\\Users\\cuish\\Documents\\PersonalProjects\\pad-auto\\script"
...
def write_path_script(path):
    ...
    y, x = int((path[0][0]+1) * size - size / 2 +
               ystart), int((path[0][1]+1) * size - size / 2 + xstart)
    ...
    for p in path[1:]:
        ...
        f.write("MonkeyRunner.sleep(0.1)\r\n")
